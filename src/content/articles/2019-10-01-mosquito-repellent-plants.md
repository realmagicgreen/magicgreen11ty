...
{% include partials/image.html name="-03" caption="Garlic plant" %}
...
{% include partials/image.html name="-02" caption="Mint plant" %}
...
{% include partials/image.html name="-04" caption="Citronella plant" %}
...
{% include partials/image.html name="-05" caption="Lavender plant" %}
...
{% include partials/image.html name="-06" caption="Catnip plant" %}
...
{% include partials/image.html name="-07" caption="Basil plant" %}
...
{% include partials/image.html name="-08" caption="Rosemary plant" %}
