...
{% include partials/image.html name="-06" caption="Vince Tierny showroom" %}
...
{% include partials/image.html name="-04" caption="Vince Tierny" %}
...
{% include partials/image.html name="-05" caption="Vince Tierny board detail" %}
...
{% include partials/image.html name="-03" caption="Vince Tierny showroom" %}
