...
{% include partials/image.html name="-02" caption="Areca palm" %}
...
{% include partials/image.html name="-05" caption="Aloe Vera" %}
...
{% include partials/image.html name="-06" caption="Mother-in-law's tongue, also called Snake plant" %}
...
{% include partials/image.html name="-04" caption="Peepal tree" %}
...
{% include partials/image.html name="-07" caption="Orchids" %}
...
{% include partials/image.html name="-08" caption="Spider Plant" %}
...
{% include partials/image.html name="-09" caption="Lavender" %}
...
{% include partials/image.html name="-10" caption="Gardenia" %}
...
{% include partials/image.html name="" caption="English Ivy" %}
...
{% include partials/image.html name="-12" caption="Jasmine" %}
...
{% include partials/image.html name="-13" caption="Rosemary" %}
